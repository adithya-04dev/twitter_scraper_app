...
os.environ['AWS_ACCESS_KEY_ID'] = 'AKIA5CBFFCK6VN4BCGM5'
os.environ['AWS_SECRET_ACCESS_KEY'] = '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'
...
- Twitter is experiencing unusual activity"""
    ...
    def save_to_csv(self):
        ...
        # s3.put_object(Bucket='csvfiles-cricmetric-clone', Key='scraped-tweets.csv', Body=csv_buffer.getvalue())
    ...
    def get_tweets(self):
        return self.data
USER_UNAME = "adithya_dev4"
USER_PASSWORD = "techradar"
